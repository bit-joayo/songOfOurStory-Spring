...
<body style="background-image:url('img/background/back_11.jpg')">
		...
		<header class="jumbotron my-4">
			...
			<p>
				<textarea id="textarea" name="textarea" class="form-control"
					rows="15" onkeyup="textSize();"></textarea>
			</p>
			<p>
				<input type="text" size=2 name="textSizeCheck" id="textSizeCheck"
					readonly>/500<br>
			</p>
			<input type="hidden" id="userId" value="${userVo.userId}"> <a
				href="#" class="btn btn-primary btn-block" id="btn1">작성완료 노래추천받기</a>
		</header>
